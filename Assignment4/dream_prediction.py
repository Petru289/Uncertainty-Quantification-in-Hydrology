...
#plt.title("Mean prediction of concentration at 100 meters using only measurements at well x = 5 meters") #set corresponding title


#Uncomment this for plot in report figure 4.4
